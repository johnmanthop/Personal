...
#define COLOR_BACKGROUND 	 0x8544
...
#define	CSX_PORT	GPIOA
#define CSX_PIN		(1U << 9) //Chip select
#define RESX_PORT	GPIOA
#define RESX_PIN	(1U << 10) //Reset pin
#define	CMD_PORT	GPIOA
#define CMD_PIN		(1U << 8) //Command select
...
void draw_bitmap(int y1, int x1, int scale, int width, int height, const unsigned int *bmp);
void IM_draw_bitmap(int y_start, int x_start, int scale, const unsigned int bmp[18][15]);
#endif	/* ILI9225_H */
